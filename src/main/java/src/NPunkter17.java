...
* Eng: Class NPunkter17 to find n random, different points in the x,y-plane
* ver 7.mai 2015. Reworked to get not cohyll be a square for large n
* ver 13.04.2020 - added seed as a parameter for generating random points instead of hard-coded seed
************************************************************************/
